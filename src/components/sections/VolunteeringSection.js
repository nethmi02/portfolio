...
export default function Volunteering() {
    ...
    return (
        <section id="volunteering" className="bg-gradient-to-br from-black via-purple-950/25 to-black pt-20 pb-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row md:gap-12">
                    ...
                    <Reveal delay={0.2} className="md:w-5/12 w-full mb-12 md:mb-0">
                    ...
                    <Reveal delay={0.4} className="md:w-7/12 w-full">
                        <div className="flex items-center gap-3 mb-4">
